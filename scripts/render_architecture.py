...
def draw() -> Path:
    ...
    for x, y, w, h, title in plane_boxes:
        ...
        ax.text(x + 0.15, y + h - 0.22, title, color="#9fb4d8", fontsize=10, fontweight="bold")
    ...
    for src, dst, label in EDGES:
        ...
        if label:
            ...
            ax.text(mx, my, label, color="#bccae0", fontsize=8, ha="center", va="center")
    ...
    ax.set_title(
        "Drift-Aware Adaptive Retraining: System Architecture",
        color="#dfe6f3",
        fontsize=13,
        fontweight="bold",
        pad=18,
